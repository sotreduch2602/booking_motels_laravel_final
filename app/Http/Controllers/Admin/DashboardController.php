...
class DashboardController extends Controller
{
    ...
    public function restoreUser($id)
    {
        ...
        if ($user->trashed()) {
            $user->restore();
            return redirect()->route('admin.pages.dashboard')->with('success', 'User restored successfully!');
        }
        return redirect()->route('admin.pages.dashboard')->with('error', 'User is not deleted.');
    }
}
